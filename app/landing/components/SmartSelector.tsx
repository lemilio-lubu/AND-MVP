      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-fib-3 max-w-6xl mx-auto">
          ...
          <motion.div 
            ...
            className="cursor-pointer group relative h-[600px] rounded-[40px] overflow-hidden bg-[var(--surface)] dark:bg-slate-900/50 border border-[var(--primary)]/20 dark:border-white/10 shadow-[0_0_40px_rgba(4,89,50,0.1)] hover:shadow-[0_0_60px_rgba(4,89,50,0.2)] transition-all duration-500"
          >
            ...
            <div className="relative h-full flex flex-col justify-between p-fib-4">
              <div>
                <div className="mb-fib-2 inline-flex p-fib-1 rounded-xl bg-[var(--primary)]/10 text-[var(--primary)] dark:text-emerald-400 border border-[var(--primary)]/20 shadow-[0_0_15px_rgba(4,89,50,0.1)]">
          ...
          <motion.div 
            ...
            className="cursor-pointer group relative h-[600px] rounded-[40px] overflow-hidden bg-[var(--surface)] dark:bg-slate-900/50 border border-[var(--accent)]/20 dark:border-white/10 shadow-[0_0_40px_rgba(3,166,74,0.1)] hover:shadow-[0_0_60px_rgba(3,166,74,0.2)] transition-all duration-500"
          >
            ...
            <div className="relative h-full flex flex-col justify-between p-fib-4">
              <div>
                <div className="mb-fib-2 inline-flex p-fib-1 rounded-xl bg-[var(--accent)]/10 text-[var(--accent)] dark:text-green-400 border border-[var(--accent)]/20 shadow-[0_0_15px_rgba(3,166,74,0.1)]">

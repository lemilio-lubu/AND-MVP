        ...
        <div className="grid md:grid-cols-2 gap-fib-2 mb-fib-3">
          ...
          <div className="bg-[var(--surface)] dark:bg-sky-900/10 rounded-fib-2 p-fib-2 border border-[var(--primary)]/20 dark:border-sky-500/30 relative overflow-hidden">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex justify-between text-[var(--accent)]/80 dark:text-emerald-400/80">
                <span>ISD (0%)</span>
                <span>$0</span>
              </div>
              <div className="flex justify-between text-[var(--text-main)]/80 dark:text-slate-400">
              ...
              <div className="pt-4 border-t border-[var(--primary)]/20 dark:border-sky-900/30 flex justify-between items-center">
                <span className="text-[var(--text-main)]/90 dark:text-slate-300">Inversión Neta</span>
                <span className="text-2xl font-bold text-[var(--primary)] dark:text-sky-400">${scenarios.localAds.total.toLocaleString("en-US")}</span>
              </div>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-fib-2">
                ...
                <div className="flex flex-col items-center md:items-end gap-[8px]">
                    <div className="flex items-baseline gap-fib-1">
                        <span className="text-sm text-[var(--accent)] dark:text-emerald-400/80 uppercase tracking-wider font-semibold">Ahorro Mensual</span>
                        <span className="text-4xl font-bold text-[var(--accent)] dark:text-emerald-400">
                    ...
                    <div className="flex items-center gap-4 mt-2">
                         ...
                         <span className="text-lg font-medium text-[var(--text-main)]/80 dark:text-slate-300">
                            Anual: <span className="font-bold text-[var(--accent)] dark:text-emerald-400">${(scenarios.savings * 12).toLocaleString('en-US', { minimumFractionDigits: 0, maximumFractionDigits: 0 })}</span>
                         </span>
                    </div>
                </div>
            </div>
